...
- Navigation épisode pilotable par bouton physique GPIO — TICKET-091/101 ✅ définitif
  ...
  - ✅ **Mapping GPIO ↔ bouton confirmé (TICKET-101, boîtier réel)** : GPIO25 = source HP/casque, GPIO13 = vol−, GPIO17 = précédent, GPIO12 = play/pause (fusionné, un seul bouton), GPIO27 = suivant, GPIO5 = vol+, GPIO16 = favori (TICKET-046, codé le 2026-07-19 — tap = bascule le favori, maintien = écran favoris), GPIO23 = bouton isolé (emplacement antenne) — physiquement câblé, réserve pour un usage futur non défini (écarté du favori), GPIO6 = non câblé
