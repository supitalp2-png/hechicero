# Archive des tickets terminés — Hechicero

> Détail complet des tickets clos. **Ce fichier ne se lit pas d'un bout à l'autre** :
> on y cherche un numéro précis quand on veut comprendre *pourquoi* une décision a été
> prise. Le tableau de bord vivant est `90-BACKLOG.md` ; les pièges à ne pas rejouer
> sont dans `75-NON_REGRESSION.md`.

*137 tickets · dernière mise à jour 2026-08-21*

---

- [x] TICKET-133 — bug/batterie — Détection charge/décharge par le signe du courant, et cycles faussés par l'arrêt d'urgence (2026-08-17)
      ...
      - ✅ **CLOS le 2026-08-21.** Le « reste à accumuler des cycles » a été fait : trois cycles profonds ont servi à TICKET-137/139/142, qui reprennent et dépassent ce ticket.


- [x] TICKET-130 — bug/données — Neuf podcasts ont disparu de la config, en silence, pendant deux semaines (2026-08-17)
      ...
      - ✅ **CLOS le 2026-08-21.** Les neuf podcasts sont restaurés, et le verrou + les sauvegardes horodatées couvrent bien les **trois** fichiers concernés (`podcasts.json`, `parental.json`, `web/lecteur/config.json`). Le smoke test §3 vérifie le verrou et la présence des sauvegardes.


- [x] TICKET-127 — bug/instrumentation — Écran noir figé : la page cesse d'exécuter du JavaScript (2026-08-17)
      ...
      - ✅ **CLOS le 2026-08-21 côté travail** : battement de cœur et guetteur de gel livrés et vivants. La cause du gel du 2026-08-17 reste inconnue, mais **il n'y a plus rien à coder** — seulement à attendre le prochain épisode. Suivi dans « À observer ».


- [x] TICKET-126 — maintenance/batterie — Remise à zéro des mesures batterie après remplacement des cellules (2026-08-17)
      ...
      - ✅ **CLOS le 2026-08-21.** Remise à zéro faite, cellules remplacées, et le modèle a depuis été refait de fond en comble (TICKET-137/139/142) sur les cycles accumulés.
...
- [x] TICKET-145 — feature/admin — Activer ou désactiver une webradio, comme un podcast (2026-08-21) — ✅ **LIVRÉ**
      ...
      - ✅ **Éprouvé en réel par Thomas le 2026-08-21 — ticket clos.**
...
- [x] TICKET-137 (analyse préparatoire, 2026-08-18) — mesures du premier cycle, conservées pour l'historique. **La livraison est l'entrée « TICKET-137 + TICKET-139 » en tête de section.**
...
- [x] TICKET-088a — bug/backend — `play_tracker.py` n'écrivait pas `listened_s` à la fermeture ⚠️ *collision : voir aussi 088b*
...
- [x] TICKET-089a — bug/backend — `battery_watchdog.py` : errno 121 code mort ⚠️ *collision : voir aussi 089b*
...
- [x] TICKET-088b — bug/tracking — `listened_s` corrompu → épisodes à 56071 % de complétion ⚠️ *collision : voir aussi 088a*
...
- [x] TICKET-089b — bug/UX — Écran ne s'éteint pas malgré l'option activée en admin ⚠️ *collision : voir aussi 089a*
