...
Chaque fonctionnalité est isolée et remplaçable :
- Monitoring batterie
- Audio (MPD + HiFiBerry Amp4)
- Lecteur embarqué
...
- **Lecteur embarqué** : tactile, simple, pensée pour un enfant.
- **Dashboard Admin** : interface locale pour configuration, diagnostics et mises à jour.
- respect strict des règles UX définies dans `25-UX_GUIDELINES.md`
