...
> Dernière mise à jour : 2026-08-05 — **TICKET-123 : registre de non-régression** (`docs/75-NON_REGRESSION.md`, 11 zones à risque cartographiées + gardien qui alerte avant toute modif sensible) ; **TICKET-122 : chien de garde MPD** implémenté, reste à installer et valider en réel.
...
- [x] TICKET-123 — process/qualité — Registre de non-régression + gardien automatique (2026-08-05)
      ...
      - ➡️ La dette de test du §5 devient la liste de travail : Z2 (TICKET-121) et Z10 (prénom réel dans les fichiers suivis) en tête.
