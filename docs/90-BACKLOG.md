...
- [~] TICKET-126 — maintenance/batterie — Remise à zéro des mesures batterie après remplacement des cellules (2026-08-17)
      - **Contexte** : les cellules ont été **remplacées physiquement** le 2026-08-16 vers 12h. Capacité annoncée **inchangée, 6600 mAh** (`data/config.json`, `battery_capacity_mah`) — rien à modifier de ce côté. L'ancien historique décrit une batterie qui n'existe plus : il fausse `estimated_autonomy_minutes` et `consumption_by_mode`. Décision Thomas : **suppression définitive, pas d'archive**.
...
- [~] TICKET-123 — bug — L'écran ne s'éteint plus après un réveil non tactile (2026-08-05)
...
- [~] TICKET-124 — audio/UX — Gain général du casque, séparé de la courbe d'égalisation (2026-08-05)
      ...
      - 📍 **Gain courant : 4 dB** (constaté au smoke test du 2026-08-17 ; il était à 5 dB le matin même). **Changement volontaire de Thomas**, pas une dérive — vérifié auprès de lui. À retenir pour l'écoute réelle : elle doit partir d'un chiffre connu, sinon le test ne conclut rien. Le smoke test §8 affiche cette valeur à chaque passage, c'est le bon endroit pour la relever avant d'écouter.
      - ⏳ **Reste** : écoute réelle au casque **au gain de 4 dB**, puis test en voiture. Le smoke test ne saura jamais juger un niveau sonore.
